...
class DebertaV2Embeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.tfidf_embeddings = nn.Embedding(config.max_position_embeddings, self.embedding_size)
    ...
    def forward(self, input_ids=None, token_type_ids=None, tfidf_ids=None, position_ids=None, mask=None, inputs_embeds=None):
